...
def derivadaProgressiva(pontosX, pontosY, index):
    return (pontosY[index + 1] - pontosY[index]) / (pontosX[index] - pontosX[index - 1])

# Calculo da derivada retardada
...
# Calculo da interpolacao de newton, retornando a derivada real da funcao para testes
